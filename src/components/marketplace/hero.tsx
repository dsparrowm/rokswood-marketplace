...
export default function Hero() {
  return (
    <section className="bg-[var(--bg-base)] px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
      <div className="mx-auto flex max-w-7xl flex-col items-center text-center">
        ...
        <a
          href="/stores"
          className="mt-8 inline-flex h-14 items-center rounded-full bg-[var(--bg-dark)] px-8 text-base font-semibold text-[var(--text-on-dark)] shadow-[0_10px_24px_rgba(17,24,39,0.22)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-black"
        >
          Explore Stores
